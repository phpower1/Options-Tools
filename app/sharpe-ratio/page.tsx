    ...
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center p-4">
      ...
      <section className="w-full max-w-4xl mt-6 mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/sortino-ratio" className="group bg-gray-800 rounded-lg p-4 border border-gray-700 hover:border-teal-500 transition-colors">
            <p className="font-semibold text-teal-400 group-hover:text-teal-300 text-sm">Sortino Ratio Calculator</p>
            <p className="text-gray-500 text-xs mt-1">Like Sharpe, but only penalizes downside volatility.</p>
          </Link>
          <Link href="/roi-calculator" className="group bg-gray-800 rounded-lg p-4 border border-gray-700 hover:border-teal-500 transition-colors">
            ...
            <p className="text-gray-500 text-xs mt-1">Track return on investment across individual trades.</p>
          </Link>
        </div>
      </section>
