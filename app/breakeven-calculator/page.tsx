      ...
      <section className="w-full max-w-4xl mt-6 mb-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <Link href="/roi-calculator" className="group bg-gray-800 rounded-lg p-4 border border-gray-700 hover:border-teal-500 transition-colors">
            ...
            <p className="text-gray-500 text-xs mt-1">Calculate your return on investment and annualized ROI.</p>
          </Link>
          <Link href="/greeks-calculator" className="group bg-gray-800 rounded-lg p-4 border border-gray-700 hover:border-teal-500 transition-colors">
            ...
            <p className="text-gray-500 text-xs mt-1">Measure Delta, Gamma, Theta, and Vega for your option.</p>
          </Link>
        </div>
      </section>
